      ...
      <div class="header">
        <div class="container">
          <h1> Trading
            <br />
      <?php if(@$_GET['thread'] == ''){?>
          <p><a style="color: black; border-color: black; background-color: #18ff00;" class="btn btn-outline-success my-2 my-sm-0" href="trading.php?user=<?php echo $usn ?>&board=<?php echo $board ?>&thread=start" role="button">Create New Thread &raquo;</a></p>
      <?php } ?>
